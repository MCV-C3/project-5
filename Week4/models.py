...
class MCV_Net(nn.Module):    
    def __init__(self, image_size: int, block_type: str = "baseline", num_classes: int = 8, init_chan: int = 20, 
        ...
        configs = {
            ...
            "maxpool_gap_bn_p":     {"use_bn": True,  "use_pool": True,  "use_gap": True,  "use_attention": False, "use_residual": False, "use_dw": False, "use_conv_pool": False, "use_shuffle": False, "use_prelu": True},
